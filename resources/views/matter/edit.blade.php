        ...
        <div class="col-xl-8 order-xl-1">
          ...
          <form action="{{ route('matter.update', ['matter' => $matter, 'patient' => $patient]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="form-group">
                  <label for="address">Injury Story</label>
                  <textarea class="form-control" id="remarks" name="matter[remarks]" rows="3" placeholder="Enter History">{{ $matter->remarks }}</textarea>
                  ...
                  <div class="custom-control custom-checkbox">
                    ...
                    @if($injury->id == 9)
                      ...
                      <div class="col-6 col-md-3 pl-0 pt-1">
                        <input type="text" id="other" name="matter[other]" class="form-control" placeholder="Other" value="{{ $matter->other }}" style="height:30px;margin-left: -13px;">
                      </div>
                    @else
                      <div class="col-6 col-md-3">
                        <input type="checkbox" name="injuries[][injury_id]" class="custom-control-input" id="injury-{{$injury->name}}" value="{{$injury->id}}"  {{ (is_array($minjuires) && in_array($injury->id, $minjuires)) ? ' checked' : '' }}>
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="comments" name="matter[comments]" rows="3" placeholder="Enter Alert Issue">{{ $matter->comments }}</textarea>
