@extends('layouts.app', ['titlePage' => 'New Payment Method'])
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter Payment Method Name" value="{{ old('name') }}">
                    @error('name')
