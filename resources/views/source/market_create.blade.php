...
@section('content')
    <div class="header bg-gradient-secondary py-7 py-lg-8">
      ...
      <div class="col-xl-8 order-xl-1">
        <div class="card-body">
            <form action="{{ route('market-sources.store') }}" method="post">
              @csrf

              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    <label for="name">Market Source Name</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter Market Source Name" value="{{ old('name') }}">
                    @error('name')
