@extends('layouts.app', ['titlePage' => 'New Appointment Source'])
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter Appointment Source Name" value="{{ old('name') }}">
                    @error('name')
